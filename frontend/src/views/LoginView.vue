...
const divisions = [
  ...
  'Детская поликлиника №4', 'Пульмоцентр', 'Центр здоровья', 'ПСЦ Неврология','Колопроктология',
  'Хирургия №1','Хирургия №2','ДИБО','Урология','Гинекология','Гастро отделение','Неврология',
  'Приемное отделение','Терапия','Реанимация','Пульмо отделение','ЛОР','Кабинет трансфузии',
  'КДЛ','Операционный блок','Рентген отделение','Физиотерапия','ЦСО','Эндоскопическое отделение',
  'ФД и УЗИ','Отделение реабилитации','Аптека','Администрация','Баклаборатория','Школа сахарного диабета'
]
